...
start_datetime = datetime(2022,7,11)
end_datetime = datetime(2022,7,12) #Dahil degil
DataType = "spot"
            ...
            if(request.status_code == 200):
                ...
                if(DataConsolidation == "aggTrades"):
                    ...
                    for index, row in df.iterrows():
                        ...
                        sqlInsert += """
                        if not exists(select symbol from Binance_Partitioned..[Csv_Kline_1m] with(nolock) where TradeDateTime = '"""+ TradeDateTime +"""' and symbol = '"""+ Symbol +"""' )
                        BEGIN
